...
_signals = Namespace()
models_committed = _signals.signal('webapp-committed')
before_models_committed = _signals.signal('before-webapp-committed')
...
class BaseQuery(orm.Query):
    ...
    This is the default :attr:`~Model.query` object used for webapp, and exposed as :attr:`~SQLAlchemy.Query`.
...
class SQLAlchemy(object):
    ...
    def make_declarative_base(self, model, metadata=None):
        """Creates the declarative base that all webapp will inherit from.
